...
include'header.php'
 ?>
  ...
  <div id="abahome-layout" class="container-meu">
            ...
            <div class="login">
              ...
              <form action="">
                ...
                <div class="centralizar" style="margin-top: 5vh;">
                  ...
                  <a href="" data-bs-target="#staticBackdrop2" data-bs-toggle="modal"
                    style="font-size: 0.8em; text-align: center; margin-top: 2vh;">Não tem uma conta? <br>
                    cadastra-se!</a>
                </div>
              </form>
            </div>
    ...
    <div class="modal modal-cadastro fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
      aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="cadastro">
              ...
              <form id="cadastraUser">
                ...
                <div class="centralizar" style="margin-top: 5vh;">
                  ...
                  <a href="" data-bs-target="#staticBackdrop" data-bs-toggle="modal"
                    style="font-size: 0.8em; text-align: center; margin-top: 3px;">Tem uma conta? <br>
                    Faça login</a>
                </div>
              </form>
            </div>
